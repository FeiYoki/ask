...
<link rel="dns-prefetch" href="//sugg.search.wenwen.sogou.com"/>
<link rel="dns-prefetch" href="//hint.wenwen.sogou.com"/>
...
<link rel="dns-prefetch" href="//p.qpic.cn"/>
...
<link rel="search" type="application/opensearchdescription+xml" href="//wenwen.sogou.com/wenwenSearch.xml" title="问问搜索"/>
    ...
    <link rel="stylesheet" type="text/css" href="css/usercenter_3266ace.css" />
</head>
...
<div id="header" class="usercenter">
    ...
    <div class="uc-searchbox">
                <div class="login" data-score="32">
            <div id="userNotice" class="user-notice"></div>
        <span class="login-line"></span>
        <div class="user-option">
            <a href="/user/center" class="btn-user-option">
                <div class="user-thumb"><img src="picture/416dbdae42b94c4bbe275f872a6db958.gif" width="100%" height="100%" alt="头像"></div>
                <div class="user-name-box"><div class="user-name">㊣ live。</div></div>
                <i class="arr-user"></i>
            </a>
            <ul class="popup-lst">
        ...
        <a href="/"><span class="uc-logo"></span></a>
    ...
    <div class="uc-top">
        <div class="uc-top-lft">
            <div class="uc-top-lft-box">
                    ...
                    <img src="picture/416dbdae42b94c4bbe275f872a6db958.gif" width="100%" height="100%" alt="头像">
                </div>
                            </div>
        </div>
        <div class="mycard-name-box">
            <div class="mycard-name">㊣ live。</div>
            <span class="user-level-tag">4级</span>
                    </div>
                    <div class="progress-bar-box">
                <div class="progress-bar">
                                        <span class="progress-tit">经验值</span>
                    <div class="progress-info"><div class="progress-info-inside progress-info-clr" style="width:70%"></div></div>
                    <span class="progress-tit">21/30</span>
                </div>
                <div class="progress-bar">
                    ...
                    还差&nbsp;<span class="progress-txt-clr">9</span>&nbsp;点经验值，<span class="progress-txt-clr2">0</span>&nbsp;个采纳就能升级了
                </div>
                                    <a href="/cate/tag" class="btn-progress">赚取经验 &gt;</a>
                                            <ul class="uc-info">
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">回答数</div>
                    <div class="uc-info-txt" >2</div>
                </div>
            </li>
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">采纳率</div>
                    <div class="uc-info-txt">0%</div>
                </div>
            </li>
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">问豆</div>
                    <div class="uc-info-txt" >32</div>
                </div>
            </li>
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">有用数</div>
                    <div class="uc-info-txt" >0</div>
                </div>
            </li>
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">提问数</div>
                    <div class="uc-info-txt" >1</div>
                </div>
            </li>
            <li>
                <div class="uc-info-tab">
                    <div class="uc-info-tit">活跃天数</div>
                    <div class="uc-info-txt sign_day" >0</div>
                                            <a href="javascript:;" class="btn-uc-signin" id="signin_btn" data-signed="false" data-day="0">签到&任务</a>
                                    </div>
            </li>
        </ul>
    </div>
        ...
        <div class=" uc-content " id="workSpaceContainer">
                    ...
                    <div class="uc-lft">
                        <ul class="uc-nav user_nav">
                                                                    ...
                                                                    <li data-type=recommend data-tp="0" data-tid="0">
                                        <a href="javascript:;" class="uc-tab"><i></i>
                                                                                            向我推荐
                                                                                    </a>
                                    </li>
                                                                <li data-type="question" data-tp="10"><a href="javascript:;" class="uc-tab"><i></i>我的提问</a></li>
                                <li data-type="answer" data-tp="20" data-tid=""><a href="javascript:;" class="uc-tab"><i></i>我的回答</a></li>
                                <li data-type="grow"><a href="javascript:;" class="uc-tab"><i></i>成长与徽章</a></li>
                                <li data-type="activity" id="activityBtn"><a href="javascript:;" class="uc-tab"><i></i>我的活动</a></li>
                                                    </ul>
                    </div>
                                                                        <div class="uc-rgt user_recommend_list" style="min-height: 1035px;">
                                
<div class="uc-top-bar">
    <div class="sort-nav">
        <a href="javascript:;" class="sort-nav-tab user_nav_child cur" data-type="recommend" data-tp="0">我的兴趣</a>
        <span class="sort-nav-bar"></span>
        <a href="javascript:;" class="sort-nav-tab user_nav_child  uc-new " data-type="recommend" data-tp="1">向我求助</a>
    </div>
</div>

<div id="reco_list">
    <div class="my-interest">
        <span class="my-interest-tit">兴趣分类:</span>
                            <a href="javascript:;" class="btn-interest-tab user_nav_child cur" data-type="recommend" data-tp="0" data-tid="0">全部</a>
                            <a href="javascript:;" class="btn-interest-tab user_nav_child" data-type="recommend" data-tp="0" data-tid="144670">键盘</a>
                            <a href="javascript:;" class="btn-interest-tab user_nav_child" data-type="recommend" data-tp="0" data-tid="65471">编程</a>
                        <a href="javascript:;" class="btn-interest-more setUpCategory"><i></i>添加更多</a>
            </div>

    <!-- 向我推荐 -->
    <div id="userList_recommend" class="uc-lst reco_list"></div>
    <!-- //向我推荐 -->
</div>
                            </div>
    ...
    <div class="uc-grade-box">
        <div class="uc-grade">
            <!-- 50% ~ 100% 添加 uc-grade-prompt-v1 -->
                                    <div class="uc-grade-prompt " style=" left:14%;">
                <div class="user-level">当前等级：<span>4级</span></div>
                <div class="progress-bar-box">
                    <div class="progress-bar">
                        <span class="progress-tit">经验值</span>
                        <div class="progress-info"><div class="progress-info-inside progress-info-clr" style="width:70%"></div></div>
            ...
            <div class="uc-grade-inside" style="width:14%;"></div>
...
<script>
    ...
    _gtag = {
        ...
        host:  true ,
        orig: 253,
        traceId: '40ecc16358a25006fb48eca80057ad17',
        isExpert:  false ,
        tagId: '',
        tagName: '',
        isTalent:  false ,
...
<script crossorigin="anonymous" src="js/main_7ab0fd8.js"></script>
    ...
    <div class="ft-container">
        <div class="ft-box">
            <div class="ft-lft">
                ...
                <p class="ft-lft-txt2">已解决问题:<em>262,090,385</em></p>
            </div>
            <ul class="ft-rgt">
        ...
        <div class="ft-box2">
            ...
            <p class="ft-box2-lft">© 2017 Sogou Inc. 京ICP证050897号</p>
        </div>
    </div>
</div>        <div id="popup_wrap" style="z-index:2;"></div>
    </div>
    <script crossorigin="anonymous" src="js/idata.js"></script>
<script crossorigin="anonymous" src="js/main.js"></script>
<script crossorigin="anonymous" src="js/main.js"></script></body>
